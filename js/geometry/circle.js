...
function fromDiameterToOther(di){
    ...
    radius.value = (di/2).toFixed(1);
    circumference.value =  (2*Math.PI*(di/2)).toFixed(1);
    area.value = (Math.PI*(di/2)**2).toFixed(1);
}
function fromCircumferenceToOther(cr){
    ...
    diameter.value = (diameter_local).toFixed(1);
    radius.value = (diameter_local/2).toFixed(1);
    area.value =( (cr*cr)/(4*Math.PI)).toFixed(1);
...
function fromAreaToOther(area_val){
    ...
    diameter.value = (di).toFixed(3);
    radius.value = (di/2).toFixed(3);
...
function fromRadiusToOther(r){
    ...
    diameter.value = (r*2).toFixed(1);
    circumference.value = (2*Math.PI*r).toFixed(1);
    area.value = (Math.PI*(r*r)).toFixed(1);
}